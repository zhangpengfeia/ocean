...
dom.removeChild(子DOm节点) //删除指定子dom节点，参数没有双引号
dom.children //获取dom下面所以的子元素DOm节点，返回伪数组，当做数组用
dom.previousElementSibling //获取该DOM节点上一个紧挨的兄弟元素
